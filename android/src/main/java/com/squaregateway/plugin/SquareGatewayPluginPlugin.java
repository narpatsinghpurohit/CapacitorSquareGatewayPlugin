...
@CapacitorPlugin(name = "SquareGatewayPlugin")
public class SquareGatewayPluginPlugin extends Plugin {

    private SquareGatewayPlugin implementation = new SquareGatewayPlugin();
